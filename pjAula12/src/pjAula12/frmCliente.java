...
public class frmCliente extends JFrame implements ActionListener {
    JLabel lbNome, lbCNPJ, lbTelefone, lbStatus, lbEmail, lbPessoa, lbFaturamento, lbDataCompra;
    ...
    String status[] = {"Ativo", "Inativo"}, tipo[] = {"Pessoa Física", "Pessoa Jurídica"};
    String estado[] = {"AC"	,"AL", "AP", "AM","BA","CE", 
			"DF", "ES", "GO", "MA",
			"MT", "MS" , "MG", "PB", 
			"PR", "PA","PE","PI","RJ", 
			"RN", "RS","RO",
    ...
    public frmCliente() {
        ...
        cbxPessoa = new JComboBox<String>(tipo);
